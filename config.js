window.MEDIX_SUPABASE = {
  ...
  // Opcional: solo si usas un dominio custom de functions
  // functionsUrl: "https://joywqacbtmgfjncmglks.supabase.co/functions/v1",
  // Llave PUBLICA de Wompi (sandbox o prod). El secreto de integridad NUNCA va aqui.
